...
const MyInfoContainer = () => {
  let des;
  const { menu1, menu2, menu3, menu4, menu5, menu6 } = useSelector(
  ...
  return (
    <InfoContainer>
      <motion.h1 variants={headerAin} initial="hidden" animate="visible">
        Hello, I’m Paing Sett Kyaw (Call me Paing)!
      </motion.h1>
      <motion.div
        className="info"
        key="info-container"
